pipeline {
    ...
    stages {
        ...
        stage('Push Image to Docker Hub') {
          steps {
           sh    'docker push madhudevops111/pipelinetestmaster:${BUILD_NUMBER}'
           }
        }
        ...
        stage('Deploy to Docker Host') {
          steps {
            ...
            sh    'docker -H tcp://172.168.0.137:2375  run --rm -dit --name masterwebapp1 --hostname masterwebapp1 -p 8000:80 madhudevops/pipelinetestmaster:${BUILD_NUMBER}'
            }
        }
